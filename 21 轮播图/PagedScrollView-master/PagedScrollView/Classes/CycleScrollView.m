...
{
    UIView *detailView = [[UIView alloc]initWithFrame:CGRectMake(0, self.frame.size.height - 35, self.frame.size.width, 35)];
    detailView.backgroundColor = [UIColor colorWithRed:200.0/255 green:200.0/255 blue:200.0/255 alpha:1.0];
    detailView.alpha = 0.3;
    [self addSubview:detailView];
    
    if (openImageDetails) {
        self.detailLabel = [[UILabel alloc]initWithFrame:CGRectMake(3, 0, detailView.frame.size.width - 100, detailView.frame.size.height)];
   ...
   self.pagecontroll  = [[UIPageControl alloc]initWithFrame:CGRectMake(detailView.frame.size.width - 100, 0, 100, detailView.frame.size.height)];
